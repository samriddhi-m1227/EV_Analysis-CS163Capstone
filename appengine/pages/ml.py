import os
import dash
from dash import html, dcc, Input, Output, State, ALL, ctx, callback
import requests
...
layout = html.Div([
    html.Div(
        ...
        children=[
            ...
            # LIVE EV DESERT PREDICTOR
            html.Div(
                className="card",
                children=[
                    html.H2("Live EV Desert Predictor", className="section-title"),
                    html.P(
                        "Enter community characteristics below and get a real-time prediction from the EV Desert Classifier "
                        "running as a live inference service on Google Cloud Run.",
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    html.P("Adjust the sliders and click Run Prediction to get a live result from the Cloud Run inference service.",
